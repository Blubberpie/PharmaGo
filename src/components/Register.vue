    ...
    <v-container class="mt-15">
      <v-layout row align-center justify-center class="">
        <v-flex class="" height="200px">
          <v-card rippled class="flexcard white lighten-3 mx-auto" elevation="3" rounded="xl">
                ...
                <v-flex class="ma-15 ">
                  ...
                  <v-row justify="center">
                    <v-btn
                      ...
                      @click="Register"
                      rounded
                      class="white lighten-3 teal--text"
                      >Register
                    </v-btn>
                  </v-row>
                </v-flex>
...
export default {
  data() {
    return {
      ...
      Rules: [(v) => v.length >= 3 || 'Minimum length is 3 characters'],
      passwordRules: [(v) => v.length >= 5 || 'Password must be more than 5 characters'],
    };
  },
  methods: {
    async Register() {
